...
public class Account implements Serializable {
	 ...
	 *
	 * @param userNaam
	 *            de gewenste gebruikersnaam om mee in te loggen
	 * @param password
	 *            het gewenste wachtwoord om mee in te loggen
	 * @param rol
	 *            de rol die de betreffende gebruiker krijgt, op basis waarvan diens
	 *            rechten in de app worden bepaald
	 */
